...
if f_vendas and f_metas and meses_sel:
    ...
    with tab_geral:
        ...
        with col1:
            fig_pizza1 = criar_pizza_atingimento(total_vendas, total_meta_mensal, "Vs Meta Mensal", mostrar_rotulos)
            st.plotly_chart(fig_pizza1, use_container_width=True)
        
        with col2:
            fig_pizza_vs_meta = criar_pizza_atingimento(total_vendas, total_meta_inicial, "Vs Meta Inicial", mostrar_rotulos)
